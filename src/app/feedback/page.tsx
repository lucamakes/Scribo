      ...
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <div>
            ...
            <p className={styles.subtitle}>Vote on features and report bugs</p>
          </div>
        </div>
          ...
          <div className={styles.modal} onClick={e => e.stopPropagation()}>
            ...
            <div className={styles.loginPromptContent}>
              ...
              <div className={styles.loginPromptActions}>
                <button onClick={() => router.push('/auth/login')} className={styles.submitButton}>
                  Log in
                </button>
                <button onClick={() => router.push('/auth/signup')} className={styles.cancelButton}>
                  Sign up
                </button>
              </div>
            </div>
          ...
          <div className={styles.modal} onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.formActions}>
                ...
                <button type="submit" disabled={submitting || !newTitle.trim()} className={styles.submitButton}>
